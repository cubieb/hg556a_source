...
{
	/* start of protocol 存在读取错位 by z45221 zhangchen 2006年8月8日"
	return (unsigned int)((char *)q + (sizeof(struct Qdisc) + QDISC_ALIGN_CONST)) & ~(QDISC_ALIGN_CONST);
	*/
	return (unsigned int)((char *)q + (sizeof(struct Qdisc)));
	/* end of protocol 存在读取错位 by z45221 zhangchen 2006年8月8日" */
}
