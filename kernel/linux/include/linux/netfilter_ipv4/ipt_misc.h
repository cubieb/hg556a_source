...
struct ipt_misc_info {
    ...
    /*add by z67625 增加支持4种防攻击方式开关 start*/
    unsigned char flag_samesrcdst:1;
    unsigned char flag_brdcstsrc:1;
    unsigned char flag_lansrcip:1;
    unsigned char flag_frgmthdr:1;
    unsigned int lanip;
    unsigned int mask;
    /*add by z67625 增加支持4种防攻击方式开关 end*/
