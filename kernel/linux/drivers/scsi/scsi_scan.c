		...
		struct scsi_device **sdevp, int rescan)
{
    ...
    /*2008-2-1 start 适配HSPA数据卡E172 VDF l65130 */
    if (Is_HuaweiVID(host->hostdata[0]))
    {
        scsi_cmd[0] = 0x11;
        scsi_cmd[1] = 0x06;
        scsi_cmd[2] = 0x30;
	  ...
	  memset(result, 0, 36);
        ...
        scsi_wait_req(sreq, (void *)scsi_cmd, (void *) result, 36,
    		      HZ/2 + HZ*scsi_inq_timeout, 3);
    ...
    /*2008-2-1 end 适配HSPA数据卡E172 VDF l65130 */
