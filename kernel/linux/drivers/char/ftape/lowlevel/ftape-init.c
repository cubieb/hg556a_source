...
/*      Global vars.
 */
char ft_src[] __initdata = "$Source: \TC_FNT_HG586_CVS_CODE/HG556AV100R001/kernel/linux/drivers/char/ftape/lowlevel/ftape-init.c,v $";
char ft_rev[] __initdata = "$Revision: 1.1 $";
char ft_dat[] __initdata = "$Date: 2008/08/26 01:48:14 $";
