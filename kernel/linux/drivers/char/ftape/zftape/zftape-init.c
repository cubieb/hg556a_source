...
char zft_src[] __initdata = "$Source: \TC_FNT_HG586_CVS_CODE/HG556AV100R001/kernel/linux/drivers/char/ftape/zftape/zftape-init.c,v $";
char zft_rev[] __initdata = "$Revision: 1.1 $";
char zft_dat[] __initdata = "$Date: 2008/08/26 01:48:22 $";
