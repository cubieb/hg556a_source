...
static DECLARE_MUTEX (table_lock);
static DECLARE_MUTEX (close_mutex);
...
static int serial_open (struct tty_struct *tty, struct file * filp)
{
	...
	if (down_interruptible(&close_mutex)) {
		retval = -ERESTARTSYS;
		goto bailout_kref_put;
	}
