...
#include <asm/watch.h>
#include <asm/types.h>
/* start of maintain dying gasp by liuzhijie 00028714 2006年5月18日 */
#include <linux/dyinggasp.h>
/* end of maintain dying gasp by liuzhijie 00028714 2006年5月18日 */
	...
	const char * file, const char * func, unsigned long line)
{
	...
	show_registers(regs);
	//add by z67625
    printk("traps.c===will softreboot\n");
    kerSysMipsSoftReset();
#if defined(CONFIG_MIPS_BRCM)
#ifdef CONFIG_REMOTE_DEBUG
        {
