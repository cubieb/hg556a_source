...
/* start of AU8D01220 2008-11-19 by z67625 网关与CISCO路由器对接后，网关LAN侧PC一直ping另一端CISCO下的PC，拔插ADSL线后，VPN连接建立失败 */
#include<net/route.h>
/* end of of AU8D01220 2008-11-19 by z67625 网关与CISCO路由器对接后，网关LAN侧PC一直ping另一端CISCO下的PC，拔插ADSL线后，VPN连接建立失败 */
...
int xfrm_state_add(struct xfrm_state *x)
{
    ...
    /* start of AU8D01220 2008-11-19 by z67625 网关与CISCO路由器对接后，网关LAN侧PC一直ping另一端CISCO下的PC，拔插ADSL线后，VPN连接建立失败 */
    rt_cache_flush(-1);
    /* end of AU8D01220 2008-11-19 by z67625 网关与CISCO路由器对接后，网关LAN侧PC一直ping另一端CISCO下的PC，拔插ADSL线后，VPN连接建立失败 */
out:
	spin_unlock_bh(&xfrm_state_lock);
	xfrm_state_put_afinfo(afinfo);
...
int xfrm_state_update(struct xfrm_state *x)
{
	...
	err = 0;
    /* start of of AU8D01220 2008-11-19 by z67625 网关与CISCO路由器对接后，网关LAN侧PC一直ping另一端CISCO下的PC，拔插ADSL线后，VPN连接建立失败 */
    rt_cache_flush(-1);
    /* end of AU8D01220 2008-11-19 by z67625 网关与CISCO路由器对接后，网关LAN侧PC一直ping另一端CISCO下的PC，拔插ADSL线后，VPN连接建立失败 */
