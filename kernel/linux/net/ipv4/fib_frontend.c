 ...
 *
 * Version:	$Id: fib_frontend.c,v 1.1.2.1 2009/06/01 03:07:36 l43571 Exp $
 *
			...
			struct net_device *dev, u32 *spec_dst, u32 *itag)
{
	...
	if (in_dev) {
		...
		/* add by j00100803 to support the log of ip spoofing */
		if (rpf && net_ratelimit())
		{
			printk("<8>" "[fwlog] possible ip spoofing attack, SRC=%u.%u.%u.%u DST=%u.%u.%u.%u.\n",
	       		NIPQUAD(src), NIPQUAD(dst));
		}
	}
