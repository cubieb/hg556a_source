 ...
 *
 * ipt_dscp_j.c,v 1.8 2002/08/06 18:41:57 laforge Exp
*/
...
target(struct sk_buff **pskb,
       ...
       void *userinfo)
{
	const struct ipt_dscp_j_info *dinfo = targinfo;
...
{
	const u_int8_t dscp = ((struct ipt_dscp_j_info *)targinfo)->dscp;

	if (targinfosize != IPT_ALIGN(sizeof(struct ipt_dscp_j_info))) {
