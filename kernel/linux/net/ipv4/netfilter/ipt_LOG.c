	       ...
	       const char *prefix)
{
    ...
    /*modified by z67625 修改防火墙的日志类型统一为8 start*/
	//printk(level_string);
	printk("<8>");
    /*modified by z67625 修改防火墙的日志类型统一为8 end*/
	printk("%sIN=%s OUT=%s ",
...
/*start of 2008.05.20 HG553V100R001C02B010 AU8D00422, 增加安全日志*/
static void 
simply_dump_packet(const struct sk_buff *skb,
	                                   const struct ipt_log_info *loginfo,
	                                   const char *level_string)
{
    struct iphdr iph;
    ...
    spin_lock_bh(&log_lock);
    printk(level_string);
    printk("[fwlog] %s ", loginfo->prefix);//modified by z67625 for fwlog
...
/*end of 2008.05.20 HG553V100R001C02B010 AU8D00422, 增加安全日志*/
	       ...
	       void *userinfo)
{
	...
	level_string[1] = '8';//防火墙日志等级
	/*modified by z67625 修改防火墙的日志类型统一为8 end*/

	/*start of 2008.05.20 HG553V100R001C02B010 AU8D00422, 增加安全日志*/
	//ipt_log_packet(hooknum, *pskb, in, out, loginfo, level_string, NULL);
	simply_dump_packet(*pskb, loginfo, level_string);
	/*end of 2008.05.20 HG553V100R001C02B010 AU8D00422, 增加安全日志*/
