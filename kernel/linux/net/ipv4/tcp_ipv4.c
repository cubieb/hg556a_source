 ...
 *
 * Version:	$Id: tcp_ipv4.c,v 1.1.2.1 2009/06/01 03:07:59 l43571 Exp $
 *
...
static inline void syn_flood_warning(struct sk_buff *skb)
{
	...
	/* add by j00100803 to support the log of TCP syn flood  */
	...
	if (net_ratelimit())
	{
		printk("<8>" "[fwlog] possible SYN flooding on port %d.\n",
			ntohs(skb->h.th->dest));
	}
}
