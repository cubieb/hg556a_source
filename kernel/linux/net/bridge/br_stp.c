 ...
 *
 *	$Id: br_stp.c,v 1.2 2008/09/22 13:49:41 l65130 Exp $
 *
...
void br_topology_change_detection(struct net_bridge *br)
{
	...
	if (isroot) {
        /*start of ATP问题单同步，目前网关桥的STP是不开启的 by l129990 2008,9,9*/
        /* HUAWEI HGW s48571 2006年11月17?香港测试组播问题修改，由于目前不使用STP，所以可以作此修改，如果启用STP后需要将此修改回来。 modify begin:
		br->topology_change = 1;
		*/
		br->topology_change = 0;
		/* HUAWEI HGW s48571 2006年11月17?香港测试组播问题修改modify end. */
        /*end of ATP问题单同步，目前网关桥的STP是不开启的 by l129990 2008,9,9*/
