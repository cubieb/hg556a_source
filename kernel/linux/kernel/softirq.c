...
#if 1
#define BOARD_HG556A_55VDFA     0    
    if (BOARD_HG556A_55VDFA == kerSysGetBoardVersion()) {
        /* This will enhance IO performance. */
    	set_user_nice(current, 0);
    }
    else {        
        /* more priority and normal schedule policy for ksoftirqd. <tanyin 2009.4.2> */
...
#endif
    printk("softirq policy:%d\n",sys_sched_getscheduler(current->pid));
    printk("softirq nice:%d, prio:%d\n",task_nice(current), current->static_prio);
