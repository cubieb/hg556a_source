 ...
 *
 * $Id: 802.11.h,v 1.1 2008/08/25 06:41:26 l65130 Exp $
 */
...
typedef uint8 ac_bitmap_t;		/* AC_xx (bits 3:0 = VO, VI, BK, BE, respectively) */
...
/* QoS Info field for IE sent from AP */
...
/* QoS Info field for IE sent from STA */
...
/* ACI */
#define WME_AIFSN_MIN               1
#define WME_AIFSN_MAX               15
#define WME_AIFSN_MASK              0x0f
#define WME_ACM_MASK                0x10
#define WME_ACI_MASK                0x60
#define WME_ACI_SHIFT               5

/* ECW */
#define WME_ECW_MIN                 0
#define WME_ECW_MAX                 15
#define WME_ECW2CW(exp)             ((1 << (exp)) - 1)
#define WME_ECWMIN_MASK             0x0f
#define WME_ECWMAX_MASK             0xf0
#define WME_ECWMAX_SHIFT            4

/* TXOP */
#define WME_TXOP_MIN                0
#define WME_TXOP_MAX                65535
#define WME_TXOP2USEC(txop)         ((txop) << 5)
