 ...
 * $Id: bcmutils.h,v 1.1 2008/08/25 06:41:11 l65130 Exp $
 */
...
#ifdef DSLCPE
/* if rx from the incoming interface has preallocted rx buffers and needs them back,
 * the queue length must match the incoming interface's rx queue length 
 * for best WMM result 
 * current tested/matched interface is ethernet
 */
#define PKTQ_LEN_DEFAULT        120
#else
...
#ifdef BCMDBG
extern void prpkt(char *msg, osl_t *osh, void *p0);
#endif
