 ...
 *
 * $Id: d11.h,v 1.1 2008/08/25 06:41:58 l65130 Exp $
 */
...
typedef volatile struct _d11regs {
	...
	uint32	hw_war;
	uint32	pmu_pwrctl;		/* 0x1e8 (corerev >= 16) */
...
/* pmu_pwrctl */
#define PWRCTL_PHYPLL_AVAIL_REQ	0x000010000	/* request PHY PLL resource */
#define PWRCTL_PHYPLL_AVAIL_STS	0x001000000	/* PHY PLL is available */
...
/* RTT: where was this ever used?? Doesn't show up ... */
