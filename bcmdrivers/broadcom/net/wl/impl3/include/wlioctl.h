 ...
 *
 * $Id: wlioctl.h,v 1.1 2008/08/25 06:42:10 l65130 Exp $
 */
...
#ifdef EFI
/* This is broadcom-specific guid selector for IOCTL handler in Apple 80211 Protocol
...
typedef struct wl_bss_info {
	...
	uint8		n_cap;			/* bool : BSS is 802.11N Capable */
...
typedef struct wl_reassoc_params {
	struct ether_addr bssid;	/* default: bcast */
	int32 chanspec_num;		/* 0 use default (all available channels), count of
					 * chanspecs in chanspec_list
					 */
	chanspec_t chanspec_list[1];		/* list of chanspecs */
} wl_reassoc_params_t;
/* size of wl_ext_assoc_params not including variable length array */
#define WL_REASSOC_PARAMS_FIXED_SIZE 	(sizeof(wl_reassoc_params_t) - sizeof(chanspec_t))
...
#define WLC_GET_BANDSTATES			284	/* for Dongle EXT_STA support */
#define WLC_GET_WLC_BSS_INFO			285	/* for Dongle EXT_STA support */
#define WLC_GET_ASSOC_INFO			286	/* for Dongle EXT_STA support */
#define WLC_GET_OID_PHY				287	/* for Dongle EXT_STA support */
#define WLC_SET_OID_PHY				288	/* for Dongle EXT_STA support */
#define WLC_GET_DESIRED_SSID			289	/* for Dongle EXT_STA support */
#define WLC_GET_CHANSPEC			290	/* for Dongle EXT_STA support */
#define WLC_GET_ASSOC_STATE			291	/* for Dongle EXT_STA support */
#define WLC_SET_PHY_STATE			292	/* for Dongle EXT_STA support */
#define WLC_GET_SCAN_PENDING			293	/* for Dongle EXT_STA support */
#define WLC_GET_SCANREQ_PENDING			294	/* for Dongle EXT_STA support */
#define WLC_GET_PREV_ROAM_REASON		295	/* for Dongle EXT_STA support */
#define WLC_SET_PREV_ROAM_REASON		296	/* for Dongle EXT_STA support */
#define WLC_GET_BANDSTATES_PI			297	/* for Dongle EXT_STA support */
#define WLC_GET_BSS_WPA_RSN			298	/* for Dongle EXT_STA support */
#define WLC_GET_BSS_WPA2_RSN			299	/* for Dongle EXT_STA support */
#define WLC_GET_BSS_BCN_TS			300	/* for Dongle EXT_STA support */
#define WLC_GET_INT_DISASSOC			301	/* for Dongle EXT_STA support */
#define WLC_SET_NUM_PEERS			302	/* for Dongle EXT_STA support */
#define WLC_GET_NUM_BSS				303	/* for Dongle EXT_STA support */
#define WLC_LAST				304	/* do not change - get_var/set_var */
...
/* #define WL_NEW_MSGLEVEL_VAL 0x00000001 */
...
#define WL_LED_USER_SLOW 33
#define WL_LED_USER_MEDIUM 34
#define WL_LED_USER_FAST 35
#define WL_LED_USER_ON 36
...
typedef struct {
	bool	pci_wakeind;	/* Whether PCI PMECSR PMEStatus bit was set */
...
/* WLPLT code specific data structure start */
...
typedef struct wl_plt_continous_tx {
	uint8 		band;
	uint8		channel;
	int8		preamble;
	uint8		carrier_suppress; 
	uint8		pwrctl;
	int8		power;	
	int8		pad[2];
	uint32		ifs;	/* inter frame spacing */
...
typedef struct wl_plt_txper_start {
	...
	uint8		channel;
	uint8		preamble;
	uint8		seq_ctl;	/* on/off */
	uint8		pwrctl;	/* openloop / closed loop */
	uint8		pad[1];
	uint16		length;
...
/* WLPLT code specific data structure end */

/* Overlap BSS Scan parameters default, minimum, maximum */
#define WLC_OBSS_SCAN_PASSIVE_DWELL_DEFAULT		100	/* unit TU */
#define WLC_OBSS_SCAN_PASSIVE_DWELL_MIN			5	/* unit TU */
#define WLC_OBSS_SCAN_PASSIVE_DWELL_MAX			1000	/* unit TU */
#define WLC_OBSS_SCAN_ACTIVE_DWELL_DEFAULT		20	/* unit TU */
...
/* 
	dummy DPT definitions from TOT 12/17/07.
	Note: SJL -- This is to please compiler/linker for building the TrayApp.
			DPT is not supported in this release.
*/
...
/* Dummy DPT definitions defined above -- SJL */
