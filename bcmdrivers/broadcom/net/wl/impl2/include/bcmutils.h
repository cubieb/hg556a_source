 ...
 * $Id: bcmutils.h,v 1.1 2008/08/25 06:41:30 l65130 Exp $
 */
...
#ifdef DSLCPE
/* below is to avoid that data coming to wlan
...
#define PKTQ_LEN_DEFAULT        80  /*match NR_RX_BDS in bcmnet.h*/
#else
#define PKTQ_LEN_DEFAULT        120 /*match NR_RX_BDS in bcmnet.h*/
#endif
#define PKTQ_DROP_HIGH_WMARK    (PKTQ_LEN_DEFAULT)
#define PKTQ_DROP_LOW_WMARK     (PKTQ_LEN_DEFAULT - 8)
#endif
