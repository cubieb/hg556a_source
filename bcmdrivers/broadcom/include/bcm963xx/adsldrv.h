...
//#ifdef VDF_SPAIN
#define ADSLIOCTL_GET_CUTS_VALUE \
	_IOR(ADSLDRV_MAJOR, 24, unsigned int)
#define ADSLIOCTL_GET_ONLINE_TIME \
    _IOR(ADSLDRV_MAJOR, 25, unsigned int)
//#endif
...
//#ifdef VDF_SPAIN
#define ADSLIOCTL_GET_CUTS_VALUE \
	_IOR(ADSLDRV_MAJOR, 23, unsigned int)
#define ADSLIOCTL_GET_ONLINE_TIME \
	_IOR(ADSLDRV_MAJOR, 24, unsigned int)
//#endif
/*end VDF Spain require*/
