...
`sed s/'#define DSP_CORE_SIZE .*'/"#define DSP_CORE_SIZE $coreSize"/g $2/arch/mips/brcm-boards/bcm963xx/prom.c > $2/arch/mips/brcm-boards/bcm963xx/prom1.c`
`mv -f $2/arch/mips/brcm-boards/bcm963xx/prom1.c $2/arch/mips/brcm-boards/bcm963xx/prom.c`
`sed s/'#define DSP_INIT_SIZE .*'/"#define DSP_INIT_SIZE $initSize"/g $2/arch/mips/brcm-boards/bcm963xx/prom.c > $2/arch/mips/brcm-boards/bcm963xx/prom1.c`
`mv -f $2/arch/mips/brcm-boards/bcm963xx/prom1.c $2/arch/mips/brcm-boards/bcm963xx/prom.c`
