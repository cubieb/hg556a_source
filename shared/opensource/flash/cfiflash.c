...
/*start 2009-04-25 w45260 :for VDF Global 8M flash*/
...
/*end 2009-04-25 w45260 :for VDF Global 8M flash*/
...
/*start 2009-04-25 w45260 :for VDF Global 8M flash*/
#define ID_S29GL064AT   0x2201   /*size:8KBx8 + 64KBx127 ; Device ID: x01-->227E ;0x0E-->0x2210 ;0x0F-->0x2201;top*/
#define ID_S29GL064AB   0x2200   /*size:8KBx8 + 64KBx127 ; Device ID: x01-->227E ;0x0E-->0x2210 ;0x0F-->0x2200;bottom*/
#define ID_MX29LV640DB  0x22CB   /*size:8KBx8 + 64KBx255; Device ID: x01-->22CB;Bottom*/
#define ID_MX29LV640DT  0x22C9   /*size:8KBx8 + 64KBx255; Device ID: x01-->22C9;Top*/


/*2009-02-14 w45260:
注意一些Flash具有相同的device id(但Manufacture id 不同).
HG553 italy/spain 优先识别显示为16M的 MX128DT 和 S29GL128
*/
...
#define CFI_FLASH_DEVICES                   \
         {{ID_MX29LV128DT, "MX29LV128DT", MANUFACTURER_ID_MXIC},  \
          ...
          {ID_MX29LV640DB,  "MX29LV640DB",  MANUFACTURER_ID_MXIC}, \
          {ID_MX29LV640DT,  "MX29LV640DT",  MANUFACTURER_ID_MXIC}, \
...
struct cfi_query {
	...
	int top_bottom_indicator;  /*w45260 get flash geometry by cfi query*/
};

struct flash_name_from_id {
    unsigned short fnfi_id;
    char fnfi_name[30];
	unsigned short manuf_id; /*w45260 add */
};
...
int cfi_flash_init(flash_device_info_t **flash_info)
{
    ...
    *flash_info = &flash_cfi_dev;
	...
	case ID_I28F640J3:
            ...
            break;
        case ID_MX29LV640DB: //ID_AM29DL800B:
        case ID_AM29LV800B:
        case ID_AM29LV400B:   
        case ID_AM29LV160B:
        case ID_AM29LV320B:
    ...
    switch (device_id)
    {
		...
		case ID_MX29LV640DT:	
            ...
            break;
        default:
			/*start 2009-04-23 w45260: auto check Geometry by cfi query
			  02h = Bottom Boot Device, 03h = Top Boot Device, 
			  04h = Uniformsectors bottom WP# protect, 05h = Uniform sectors top WP# protect
			 */ 
    		if(0x03 == query.top_bottom_indicator) 
    	    {
    	        flipCFIGeometry = TRUE; 
    	    }else
    	    {
	        ...
	        printk("\n@w45260: auto check Geometry by cfi query\n");
    ...
    else    /* 对于TOP device，为什么块结构信息要倒置呢? */
    {
   ...
   if ((ID_AM29LV320MB == device_id ) || (ID_AM29LV320MT ==device_id))
   {
...
/*MINPENGWEI 20100322*/
    ...
    for( i = 0; i < 3; i++ ) {
        ...
        if (g_iReset)
        {
            cfi_flash_command(FLASH_SUSPEND, sector, 0, 0);
            CFI_USLEEP(15);
            set_current_state(TASK_INTERRUPTIBLE);
            schedule_timeout(HZ/2);
            /*resume program*/
            cfi_flash_command(FLASH_RESUME, sector, 0, 0);            
        }
    ...
    int nbytes)
{
    ...
    while (nbytes > 0) {
        ...
        if (g_iReset && (!(nbytes%8192)))
        {
            /*suspend program*/
            cfi_flash_command(FLASH_SUSPEND, sector, offset, *src);
            CFI_USLEEP(15);
            ...
            /*resume program*/
            spin_lock_irq(write_flash_lock);
            cfi_flash_command(FLASH_RESUME, sector, offset, *src);            
        }
    ...
    int flashFamily)
{
	...
	query->top_bottom_indicator = fwp[0x4F]; /*w45260: 02:Bottom ;03:Top*/
