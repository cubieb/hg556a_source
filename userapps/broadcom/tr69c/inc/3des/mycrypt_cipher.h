...
typedef struct {
   ...
   unsigned char       IV[MAXBLOCKSIZE_LEN], pad[MAXBLOCKSIZE_LEN];
   symmetric_key       key;
} symmetric_CFB;
...
typedef struct {
   int                 cipher, blocklen, padlen;
   unsigned char       IV[MAXBLOCKSIZE_LEN];
   symmetric_key       key;
} symmetric_OFB;
...
typedef struct Symmetric_CTR {
   int                 cipher, blocklen, padlen;
   unsigned char       ctr[MAXBLOCKSIZE_LEN], pad[MAXBLOCKSIZE_LEN];
   symmetric_key       key;
} symmetric_CTR;
