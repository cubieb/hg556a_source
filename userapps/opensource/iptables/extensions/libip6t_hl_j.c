...
{
	struct ip6t_hl_j_info *info = (struct ip6t_hl_j_info *) (*target)->data;
	u_int8_t value;
...
{
	const struct ip6t_hl_j_info *info = 
		(struct ip6t_hl_j_info *) target->data;
...
struct ip6tables_target HL = { NULL, 
	"HL",
	IPTABLES_VERSION,
	IP6T_ALIGN(sizeof(struct ip6t_hl_j_info)),
	IP6T_ALIGN(sizeof(struct ip6t_hl_j_info)),
	&help,
	&init,
	&parse,
