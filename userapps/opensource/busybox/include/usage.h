...
#define transtool_option    \
	...
	"\t-T, --tr143_wget    Tr143_wget diagnostics\n" \                    
	"\t-L, --testLen_wget  tr143_wget   testLen\n" \
	"\t-I, --interface_wget  tr143_wget interface\n" \
	"\t-D, --dscp               tr143_dsp\n" \
	"\t-F, --upFileName      tr143_filename"
   /* -T -L -I 标记为TR143 调用WGET */
...
#define ping_full_usage \
	...
	"\t-S SELECT\tSelect the interface used to send the ping.\n" \
