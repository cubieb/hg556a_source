...
//==============================================================
/* Debug for dnsmasq problem*/
//#define DNSMASQ_DEBUG  1
#ifdef DNSMASQ_DEBUG
#define MY_SYS_LOG(level, str, arg...) printf(str, ## arg)
#undef syslog
#define syslog MY_SYS_LOG
#endif

/* BEGIN: Added by y67514, 2008/9/24   PN:GLB:DNS需求*/


#define DEBUG(format, args...)     if(g_debug) do{\
        printf("DNSMASQ:%s:%s:%d:"format"\n",__FILE__,__FUNCTION__,__LINE__,##args);\
        } while(0)

/* END:   Added by y67514, 2008/9/24 */
//==============================================================
...
extern char configFile[FILE_NAME_LEN];
extern int g_debug;
